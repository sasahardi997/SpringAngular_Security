...
public class FileConstants {
    ...
    public static final String USER_FOLDER = System.getProperty("user.home") + "/Desktop/AleksandarPrivate/user-management-security/Server/src/main/resources/static/";
